...
# - Useful when multiple attributes across different classes share similar rules.
...
# Attempting wrong type raises a TypeError
# p1.age = "twenty"  # TypeError: 'age' must be int

# --------------------------
# Key Concepts / Real-World Context
# --------------------------
...
#    - Validating input types across multiple models in a project
#    - Enforcing read-only or computed attributes
#    - Lazy loading expensive data (e.g., database fields or files)
